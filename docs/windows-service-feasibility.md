...
| Authenticated dispatch-reader saturation/fault | Source tests passed | Current source/test binary; 2026-07-20 | Exact 64-frame capacity, two-frame upstream pressure, ordered recovery, malformed-frame termination, and no trailing-frame dispatch proven; installed named-pipe and multi-client load remain required |
